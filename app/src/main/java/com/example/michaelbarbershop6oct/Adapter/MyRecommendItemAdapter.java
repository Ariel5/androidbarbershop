...
public class MyRecommendItemAdapter extends RecyclerView.Adapter<MyRecommendItemAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.txt_shopping_item_rating.setText("gimi");
...
//        });
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TextView txt_shopping_item_rating;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            txt_shopping_item_rating = itemView.findViewById(R.id.txt_rating_recommend_item);
